  ...
  return (
    <div className="rounded-2xl border border-white/[0.06] bg-[#0d1424] p-5 h-full">
      <div className="mb-5">
        ...
        <p className="text-[11px] text-slate-600 mt-0.5">Total vs answered calls per day</p>
      </div>
      <ResponsiveContainer width="100%" height={200}>
        <ComposedChart data={data} margin={{ top: 4, right: 8, bottom: 0, left: -20 }}>
          ...
          <XAxis dataKey="date" tick={{ fill: '#475569', fontSize: 10 }} tickLine={false} axisLine={false} tickFormatter={v => v.slice(5)} />
          ...
          />
          <Legend iconSize={8} wrapperStyle={{ fontSize: 11, color: '#475569', paddingTop: 12 }} />
